...
class MultiplyFunctor final {
 public:
  ...
  __host__ __device__ __forceinline__ int32_t operator()(int32_t idx) const { return idx * num_col_; }
...
inline size_t InferTempStorageForSortPairsAscending(int32_t num_row, int32_t num_col) {
  size_t temp_storage_bytes = 0;
  if (num_row > 1) {
    using SegmentOffsetIter =
        cub::TransformInputIterator<int32_t, radix_sort::MultiplyFunctor, cub::CountingInputIterator<int32_t>>;

    cub::CountingInputIterator<int32_t> counting_iter(0);
    radix_sort::MultiplyFunctor multiply_functor(num_col);
...
template <typename KeyType, typename ValueType>
inline size_t InferTempStorageForSortPairsDescending(int32_t num_row, int32_t num_col) {
  size_t temp_storage_bytes = 0;
  if (num_row > 1) {
    using SegmentOffsetIter =
        cub::TransformInputIterator<int32_t, radix_sort::MultiplyFunctor, cub::CountingInputIterator<int32_t>>;
    ...
    auto err = cub::DeviceSegmentedRadixSort::SortPairsDescending<KeyType, ValueType, SegmentOffsetIter>(
        /* d_temp_storage */ nullptr,
        /* temp_storage_bytes */ temp_storage_bytes,
        /* d_keys_in */ nullptr,
        /* d_keys_out */ nullptr,
...
inline size_t InferTempStorageForSortKeysAscending(int32_t num_row, int32_t num_col) {
  size_t temp_storage_bytes = 0;
  if (num_row > 1) {
    using SegmentOffsetIter =
        cub::TransformInputIterator<int32_t, radix_sort::MultiplyFunctor, cub::CountingInputIterator<int32_t>>;
...
template <typename KeyType>
inline size_t InferTempStorageForSortKeysDescending(int32_t num_row, int32_t num_col) {
  size_t temp_storage_bytes = 0;
  if (num_row > 1) {
    using SegmentOffsetIter =
        cub::TransformInputIterator<int32_t, radix_sort::MultiplyFunctor, cub::CountingInputIterator<int32_t>>;
...
template <typename KeyType, typename ValueType>
void SortPairsAscending(const KeyType* keys_ptr, const ValueType* values_ptr, int32_t num_row, int32_t num_col,
                        void* temp_storage_ptr, int32_t temp_storage_bytes, KeyType* sorted_keys_ptr,
                        ValueType* sorted_values_ptr, cudaStream_t stream) {
  size_t rt_inferred_temp_storage_bytes = InferTempStorageForSortPairsAscending<KeyType, ValueType>(num_row, num_col);
...
template <typename KeyType, typename ValueType>
void SortPairsDescending(const KeyType* keys_ptr, const ValueType* values_ptr, int32_t num_row, int32_t num_col,
                         void* temp_storage_ptr, int32_t temp_storage_bytes, KeyType* sorted_keys_ptr,
                         ValueType* sorted_values_ptr, cudaStream_t stream) {
  size_t rt_inferred_temp_storage_bytes = InferTempStorageForSortPairsDescending<KeyType, ValueType>(num_row, num_col);
  // CHECK_LE(rt_inferred_temp_storage_bytes, temp_storage_bytes);
...
template <typename KeyType>
void SortKeysAscending(const KeyType* keys_ptr, int32_t num_row, int32_t num_col, void* temp_storage_ptr,
                       int32_t temp_storage_bytes, KeyType* sorted_keys_ptr, cudaStream_t stream) {
  size_t rt_inferred_temp_storage_bytes = InferTempStorageForSortKeysAscending<KeyType>(num_row, num_col);
  // CHECK_LE(rt_inferred_temp_storage_bytes, temp_storage_bytes);
...
template <typename KeyType>
void SortKeysDescending(const KeyType* keys_ptr, int32_t num_row, int32_t num_col, void* temp_storage_ptr,
                        int32_t temp_storage_bytes, KeyType* sorted_keys_ptr, cudaStream_t stream) {
  size_t rt_inferred_temp_storage_bytes = InferTempStorageForSortKeysDescending<KeyType>(num_row, num_col);
  // CHECK_LE(rt_inferred_temp_storage_bytes, temp_storage_bytes);
