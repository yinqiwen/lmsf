...
struct IntDivider {
  ...
  __host__ __device__ inline DivMod<Value> divmod(Value n) const { return DivMod<Value>(n / divisor, n % divisor); }
...
struct IntDivider<unsigned int> {
  ...
  __host__ __device__ inline unsigned int mod(unsigned int n) const { return n - div(n) * divisor; }
