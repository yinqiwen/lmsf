...
#include "tops/torch/kernel/array.h"
#include "tops/torch/kernel/integer_divider.cuh"
...
static OffsetCalculator<N, uint32_t, signed_strides> make_offset_calculator(const at::native::TensorIterator& iter) {
