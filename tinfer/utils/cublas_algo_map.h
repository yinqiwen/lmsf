...
struct cublasAlgoConfig_t {
  ...
  int n;
  int k;
  tinfer::CublasDataType data_type;
...
class cublasAlgoMap {
 ...
 public:
  ...
  bool isExist(const int batch_count, const int m, const int n, const int k, const tinfer::CublasDataType data_type);

  cublasLtMatmulAlgo_info getAlgo(const int batch_count, const int m, const int n, const int k,
