...
#include "tinfer/kernel/cutlass_extensions/arch/mma.h"

#include "tinfer/kernel/cutlass_extensions/gemm/threadblock/dq_mma_multistage.h"
#include "tinfer/kernel/cutlass_extensions/gemm/warp/default_mma_tensor_op.h"
#include "tinfer/kernel/cutlass_extensions/gemm/warp/mma_tensorop_compute_B_with_f16.h"
#include "tinfer/kernel/cutlass_extensions/tile_interleaved_layout.h"

#include "tinfer/kernel/cutlass_extensions/gemm/threadblock/default_dq_mma.h"
...
struct DqMma<ElementA, LayoutA, kAlignmentA, ElementB, LayoutB, kAlignmentB, ElementScale, LayoutScale, kAlignmentScale,
  ...
  using ThreadblockMma = cutlass::gemm::threadblock::DqMmaMultistage<
      ...
      layout::RowMajor, typename MmaCore::MmaPolicy, kStages, Converter, SharedMemoryClear>;
};
