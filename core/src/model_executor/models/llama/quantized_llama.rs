...
impl LayerWeights {
    ...
    fn forward_attn<F: TensorCreator>(
        &mut self,
        ...
        // let q = self.apply_rotary_emb(&q, positions)?;
        // let k = self.apply_rotary_emb(&k, positions)?;
        ...
        let y = self.attention_wo.forward(&attn_output)?;
...
impl ModelWeights {
    ...
    pub fn from_gguf<R: std::io::Seek + std::io::Read>(
        ...
        for layer_idx in 0..block_count {
            ...
            layers.push(LayerWeights {
                ...
                rotary_emb: Arc::new(RotaryEmbedding::new(
                    device,
                    DType::F16,
                    head_dim,
                    head_count_kv,
        ...
        Ok(Self {
            ...
            span,
            span_output,
            block_arena: [TensorArena::new(device), TensorArena::new(device)],
        })
    }
    ...
    fn do_forward(
        ...
        for (idx, layer) in self.layers.iter_mut().enumerate() {
            ...
            let attn = if let Some(kv_caches) = kv_caches {
                layer.forward_attn(
